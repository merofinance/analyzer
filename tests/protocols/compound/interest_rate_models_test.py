...
def test_jump_rate_model():
    ...
    model = JumpRateModel(BLOCK_NUMBER)
...
def test_usdt_rate_model():
    ...
    model = USDTRateModel(BLOCK_NUMBER)
...
def test_base0bps_slope2000bps_rate_model():
    ...
    model = Base0bpsSlope2000bpsRateModel(BLOCK_NUMBER)
...
def test_base200bps_slope1000bps_rate_model():
    ...
    model = Base200bpsSlope1000bpsRateModel(BLOCK_NUMBER)
...
def test_base200bps_slope3000bps_rate_model():
    ...
    model = Base200bpsSlope3000bpsRateModel(BLOCK_NUMBER)
...
def test_base500bps_slope1200bps_rate_model():
    ...
    model = Base500bpsSlope1200bpsRateModel(BLOCK_NUMBER)
...
def test_base500bps_slope1500bps_rate_model():
    ...
    model = Base500bpsSlope1500bpsRateModel(BLOCK_NUMBER)
